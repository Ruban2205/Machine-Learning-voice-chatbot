...
__all__ = [
    'SPRST_NUM_STATES', 'DISPID_SDKSetBinaryValue',
    'DISPID_SVPriority', 'SpeechTokenKeyAttributes',
    'DISPID_SRCEAudioLevel', 'DISPID_SGRSRule',
    'ISpeechPhraseElement', 'SpeechRecoContextState',
    'DISPID_SLWsCount', 'SPEI_MAX_SR', 'DISPID_SGRsFindRule',
    'DISPID_SPCIdToPhone', 'SP_VISEME_5', 'SVP_5', 'SpAudioFormat',
    'SPRULESTATE', 'DISPID_SRIsUISupported', 'SAFTGSM610_22kHzMono',
    'SPDKL_CurrentUser', 'SPEI_SR_PRIVATE',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpShortcut', 'SpeechVisemeType',
    'ISpEventSink', 'DISPID_SMSSetData', 'SpeechAudioFormatType',
    'SAFT44kHz8BitStereo', 'SpResourceManager', 'DISPID_SMSAMMHandle',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechSpecialTransitionType',
    'DISPID_SpeechPhraseAlternates', 'SPSModifier',
    'DISPID_SDKOpenKey', 'SSTTTextBuffer', 'ISpNotifyTranslator',
    'ISpDataKey', 'DISPID_SLGetWords',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SRRAudioFormat',
    'SLOStatic', 'DISPID_SVEVoiceChange', 'SpeechAudioFormatGUIDWave',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SDKEnumKeys', 'SPPS_Unknown',
    'SpeechPropertyAdaptationOn', 'DISPID_SPRsItem',
    'DISPID_SLRemovePronunciationByPhoneIds', 'ISpeechGrammarRules',
    'SVP_12', 'DISPID_SLWsItem', 'SpUnCompressedLexicon',
    'SPEI_RECOGNITION', 'SVEBookmark', 'DISPID_SPIElements',
    'SDTDisplayText', 'SP_VISEME_19', 'ISpPhoneConverter',
    'DISPID_SpeechBaseStream', 'DISPID_SGRClear', 'SAFT8kHz16BitMono',
    'DISPID_SpeechAudioFormat', 'DISPID_SPPs_NewEnum',
    'DISPID_SWFEAvgBytesPerSec', 'ISpeechPhraseInfoBuilder',
    'SGRSTTWildcard', 'DISPID_SGRAttributes', 'SPDKL_DefaultLocation',
    'UINT_PTR', 'SRARoot', 'DISPID_SRGCmdLoadFromMemory',
    'SPVPRI_OVER', 'SRESoundEnd', 'SGRSTTWord', 'SASStop',
    'eLEXTYPE_PRIVATE3', 'SpeechCategoryVoices', 'ISpSerializeState',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SAVolume',
    'DISPID_SRAudioInput', 'Speech_StreamPos_Asap',
    'SPFM_OPEN_READONLY', 'SpeechRegistryUserRoot', 'SPINTERFERENCE',
    'SITooFast', 'ISpeechAudioFormat', 'SAFT48kHz16BitMono',
    'eWORDTYPE_ADDED', 'SPSUnknown', 'ISpProperties',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SPRuleParent',
    'IEnumSpObjectTokens', 'SITooSlow', 'DISPID_SRCVoice',
    'SAFT12kHz16BitMono', 'DISPID_SPRulesCount',
    'SPWORDPRONOUNCEABLE', 'SpeechCategoryAudioIn',
    'SDA_Two_Trailing_Spaces', 'SPAUDIOSTATUS',
    'DISPID_SPRuleEngineConfidence', 'SVP_14', 'SPAR_Medium',
    'DISPIDSPTSI_SelectionLength', 'SVP_7', 'ISpRecognizer2',
    'SPCATEGORYTYPE',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE12', 'DISPID_SRCERecognition',
    'IInternetSecurityMgrSite', 'SPAS_STOP', 'SpPhoneConverter',
    'DISPID_SPPsCount', 'ISpeechAudioBufferInfo', 'DISPID_SOTCId',
    'DISPID_SRGCommit', 'SPLEXICONTYPE', 'DISPID_SRCEEnginePrivate',
    'SPEI_RESERVED6', 'ISpResourceManager',
    'DISPID_SpeechLexiconProns', 'DISPID_SLWWord', 'SVEVoiceChange',
    'DISPID_SGRSTPropertyValue', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPSHT_NotOverriden', 'SPINTERFERENCE_NOISE',
    'DISPID_SRGetFormat', 'SRCS_Disabled', 'SPRULE',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRRAlternates',
    'SRTExtendableParse', 'SVSFIsXML', 'SRSActiveAlways',
    'ISpeechPhraseElements', 'DISPID_SLAddPronunciation',
    'DISPID_SDKGetStringValue', 'SPSHT_OTHER', 'SPVPRI_NORMAL',
    'SP_VISEME_10', 'SpStream', 'SAFTNonStandardFormat',
    'SDTReplacement', 'SASRun',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVSFNLPMask',
    'ISpRecoContext2', 'SASPause', 'DISPID_SVEBookmark',
    'SPCT_SUB_DICTATION', 'DISPID_SPRuleConfidence',
    'DISPID_SGRSTWeight', 'SVEPrivate', 'SVF_Stressed',
    'DISPID_SGRSTPropertyName', 'DISPID_SPIGetText',
    'DISPID_SLPsItem', 'SpeechCategoryPhoneConverters',
    'DISPID_SRCRecognizer', 'DISPID_SRGId', 'SPEI_RECO_STATE_CHANGE',
    'SPAR_High', 'SDTProperty', 'SECFIgnoreCase', 'SAFT8kHz8BitMono',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SCSBaseStream', 'SPAO_NONE',
    'DISPID_SRGSetTextSelection', 'SGRSTTRule',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRCESoundStart',
    'DISPID_SVEPhoneme', 'ISpeechDataKey', 'SPSLMA', 'SPAS_CLOSED',
    'Speech_StreamPos_RealTime', 'DISPID_SLGetGenerationChange',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPRECOSTATE',
    'DISPID_SpeechRecoResult2', 'DISPID_SPAPhraseInfo', 'SP_VISEME_7',
    'ISpeechObjectToken', 'DISPID_SRGRecoContext',
    'DISPID_SpeechAudio', 'SAFT11kHz16BitStereo',
    'SpeechPropertyHighConfidenceThreshold', 'SPEI_WORD_BOUNDARY',
    'SVEAllEvents', 'SpeechStreamFileMode', 'SpNullPhoneConverter',
    'DISPID_SRCreateRecoContext', 'DISPID_SLGenerationId',
    'SPXRO_Alternates_SML', 'DISPID_SWFEFormatTag', 'SPEI_HYPOTHESIS',
    'DISPID_SRSAudioStatus', 'SPEI_END_INPUT_STREAM', 'SP_VISEME_21',
    'SVEPhoneme', 'DISPID_SRCState', 'DISPID_SpeechXMLRecoResult',
    'SBOPause', 'ISpPhrase', 'SP_VISEME_0', 'SPWORD',
    'DISPID_SPEDisplayText', 'SREStateChange', 'SPEI_VOICE_CHANGE',
    '_RemotableHandle', 'DISPID_SRCERecognitionForOtherContext',
    'SPEI_RESERVED3', 'SRTReSent', 'SRTEmulated',
    'DISPID_SpeechRecoResult', 'DISPID_SVEViseme', 'SVP_9',
    'SpeechEngineProperties', 'SPGS_ENABLED', 'SPCT_SUB_COMMAND',
    'SAFTADPCM_22kHzMono', 'SP_VISEME_2', 'SVSFPurgeBeforeSpeak',
    'DISPID_SABIBufferSize', 'ISpeechLexiconWords', 'STSF_FlagCreate',
    'SVSFParseSapi', 'SpeechTokenValueCLSID',
    ...
    'SPLO_DYNAMIC', 'eLEXTYPE_PRIVATE2', 'SPEI_FALSE_RECOGNITION',
    'SREHypothesis', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SREAdaptation', 'SPRECOGNIZERSTATUS', 'SGDSActiveWithAutoPause',
    'SPGRAMMARSTATE', 'ISpeechRecoResultDispatch', 'ISpStreamFormat',
    'SPSERIALIZEDRESULT', 'ISpNotifySink', 'SPRECOCONTEXTSTATUS',
    'tagSTATSTG', 'SDTLexicalForm', 'STCLocalServer', 'SVPOver',
    'DISPID_SVEAudioLevel', 'SpeechGrammarTagUnlimitedDictation',
    'SAFT11kHz8BitMono', 'SAFT44kHz16BitMono',
    'DISPID_SPAStartElementInResult', 'SpeechPropertyResponseSpeed',
    'DISPID_SVSInputSentencePosition', 'SECFIgnoreWidth',
    'SPSTREAMFORMATTYPE', 'SPEI_TTS_BOOKMARK', 'SVEViseme',
    'eLEXTYPE_APP', 'SPEI_TTS_PRIVATE', 'ISpeechRecoResult2',
    'DISPID_SPIRule', 'SPPHRASEREPLACEMENT',
    'SDA_Consume_Leading_Spaces', 'SVP_19', 'SDTAlternates',
    ...
    'SPINTERFERENCE_NOSIGNAL', 'SpeechPartOfSpeech',
    'SAFTCCITT_ALaw_22kHzMono', 'SGLexical', 'SPRST_ACTIVE',
    'SRATopLevel', 'DISPID_SGRSTransitions', 'SPEI_END_SR_STREAM',
    'SPEI_MIN_TTS', 'DISPID_SBSFormat',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechLexiconWord', 'DISPID_SDKSetLongValue',
    'DISPID_SRDisplayUI', 'SPSNotOverriden', 'SPPS_Noun',
    'SVSFParseMask', 'SVPAlert', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SPPsItem', 'SAFT12kHz8BitStereo', 'DISPID_SAEventHandle',
    'DISPID_SVSpeakCompleteEvent', 'eWORDTYPE_DELETED', 'SVP_21',
    'SPPS_RESERVED3', 'DISPID_SpeechPhraseElements', 'SPSHT_Unknown',
    'SpObjectToken', 'ISpeechMMSysAudio', 'DISPID_SVVoice',
    'SAFT48kHz16BitStereo', 'SAFTCCITT_uLaw_44kHzMono',
    'ISpeechRecoResultTimes', 'ISpeechRecoResult', 'DISPID_SPAsCount',
    'DISPIDSPTSI', 'ISpeechObjectTokens', 'eLEXTYPE_PRIVATE6',
    'DISPID_SRCEInterference', 'DISPID_SLPsCount',
    ...
    'DISPID_SMSALineId', 'DISPID_SRCRetainedAudioFormat',
    'SPDATAKEYLOCATION', 'ISpObjectTokenCategory',
    'DISPID_SPRuleFirstElement', 'SWPKnownWordPronounceable',
    'SpeechTokenIdUserLexicon', 'SVSFParseAutodetect',
    'SECFIgnoreKanaType', 'SECNormalConfidence',
    'DISPID_SVSInputWordPosition', 'ISpeechRecoContext',
    'DISPID_SPPFirstElement', 'SpeechDiscardType', 'SP_VISEME_4',
    'SLTUser', 'ISpPhoneticAlphabetConverter',
    'DISPID_SRSSupportedLanguages', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SPEAudioTimeOffset', 'SITooQuiet', 'SVP_15',
    'DISPID_SFSClose', 'DISPID_SOTGetAttribute', 'SREStreamEnd',
    'SPSMF_UPS', 'SECFEmulateResult',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'eLEXTYPE_RESERVED8', 'SPPHRASEPROPERTY', 'DISPID_SRGState',
    'eLEXTYPE_PRIVATE14', 'SAFT16kHz8BitMono',
    'SpObjectTokenCategory', 'DISPID_SVSLastBookmark',
    'DISPID_SVGetVoices', 'SINoise', 'SPPS_Verb', 'SPEI_RESERVED2',
    'SAFT48kHz8BitMono', 'SFTSREngine', 'DISPID_SGRSTs_NewEnum',
    'SRADynamic', 'DISPID_SRCEBookmark',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'eLEXTYPE_PRIVATE11',
    'DISPID_SLWLangId', 'ISpEventSource', 'SPWT_DISPLAY',
    'DISPID_SDKEnumValues', 'SPPS_Function', 'SPFM_OPEN_READWRITE',
    'SASClosed', 'DISPID_SABIEventBias', 'ISpeechPhoneConverter',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SRGDictationUnload',
    'DISPID_SASFreeBufferSpace', 'SPWORDPRONUNCIATION',
    'SPRST_INACTIVE', '__MIDL_IWinTypes_0009', 'SpeechRunState',
    'ISpeechVoice', 'SpeechRuleState', 'SpeechAudioState',
    'DISPID_SPRuleChildren', 'DISPID_SpeechPhraseInfo',
    'SAFTCCITT_uLaw_8kHzStereo', 'SBONone', 'SPEI_REQUEST_UI',
    'SAFTCCITT_ALaw_44kHzStereo', 'SWTDeleted',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SpeechVoiceEvent',
    'DISPID_SPRsCount', 'SAFT11kHz8BitStereo',
    'SpeechRecognizerState', 'SPAR_Low', 'SpeechEngineConfidence',
    'ISpeechPhraseReplacements', 'DISPID_SRProfile', 'SP_VISEME_3',
    'SAFTGSM610_8kHzMono', 'DISPID_SGRSTText', 'SDKLCurrentConfig',
    'DISPID_SMSADeviceId', 'SPPS_RESERVED1', 'DISPID_SVAlertBoundary',
    'ISpeechPhraseReplacement', 'DISPID_SPIReplacements',
    'SRCS_Enabled', 'DISPID_SRCEHypothesis', 'SRSInactive', 'SINone',
    'SREPropertyNumChange', 'SPRS_INACTIVE',
    'DISPID_SPPNumberOfElements', 'ISpeechMemoryStream',
    'DISPID_SPPConfidence', 'DISPID_SPEsCount', 'SVSFNLPSpeakPunc',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRCEAdaptation',
    'DISPID_SGRAddState', 'SpSharedRecognizer',
    'DISPID_SVGetAudioOutputs', 'STSF_CommonAppData',
    'SpeechRecoProfileProperties', 'SAFT16kHz16BitMono',
    'DISPID_SOTMatchesAttributes', 'SDKLDefaultLocation',
    'SSFMOpenForRead', 'SpeechWordType', 'DISPID_SDKDeleteValue',
    'SP_VISEME_18', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SPEDisplayAttributes', 'SRAInterpreter', 'SPWT_LEXICAL',
    'DISPID_SVGetProfiles', 'DISPID_SOTDisplayUI',
    'DISPID_SLPPartOfSpeech', 'eLEXTYPE_PRIVATE16', 'SPVPRI_ALERT',
    'SPAUDIOOPTIONS', 'DISPID_SPACommit', 'DISPID_SRCRequestedUIType',
    'SpCustomStream', 'DISPID_SVSPhonemeId',
    'DISPID_SREmulateRecognition', 'DISPID_SPERequiredConfidence',
    'SPADAPTATIONRELEVANCE', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRCCreateGrammar', 'SPSNoun', 'DISPID_SVEStreamStart',
    'SDTRule', 'ISpeechXMLRecoResult', 'DISPID_SGRsCommit',
    'SAFT48kHz8BitStereo', 'DISPID_SAFGuid', 'SDTAll',
    ...
    'DISPID_SGRSTsItem', 'SSTTDictation',
    'DISPID_SLAddPronunciationByPhoneIds', 'ISpXMLRecoResult',
    'DISPID_SBSWrite', 'SPAR_Unknown', 'ISpRecognizer',
    'SAFTCCITT_uLaw_11kHzStereo', 'SRAORetainAudio', 'SGSEnabled',
    'SpLexicon', 'SAFTADPCM_44kHzStereo', 'SPRS_ACTIVE',
    'SAFT32kHz8BitMono', 'DISPID_SPRules_NewEnum',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SGRSTPropertyId',
    'SGSExclusive', 'SP_VISEME_13', 'SpeechRegistryLocalMachineRoot',
    'SPTEXTSELECTIONINFO', 'DISPID_SpeechGrammarRules',
    'SPEI_START_INPUT_STREAM', 'SREFalseRecognition', 'SP_VISEME_6',
    'DISPID_SRCEStartStream', 'ISpRecognizer3', 'DISPID_SGRs_NewEnum',
    'DISPID_SRGIsPronounceable', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SVAudioOutputStream',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SRTAutopause',
    'SpeechVoiceSpeakFlags', 'SRSActive', 'DISPID_SPIEngineId',
    'SPPS_SuppressWord', 'SGRSTTTextBuffer', 'STSF_AppData',
    'SRSInactiveWithPurge', 'DISPID_SGRsCommitAndSave',
    'SPPS_RESERVED4', 'SpeechTokenKeyFiles', 'SVSFUnusedFlags',
    'SAFTExtendedAudioFormat', 'SPBO_PAUSE',
    'SPEI_RECO_OTHER_CONTEXT', 'SSSPTRelativeToEnd',
    'DISPID_SVStatus', 'DISPID_SVResume', 'DISPID_SOTsCount',
    'DISPID_SVRate', 'DISPID_SRSetPropertyNumber',
    'eLEXTYPE_PRIVATE20', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPILanguageId', 'SPINTERFERENCE_TOOFAST',
    'ISpGrammarBuilder', 'DISPID_SRGetPropertyString', 'ISpAudio',
    'SPXMLRESULTOPTIONS', 'ISpeechVoiceStatus',
    ...
    'SRESoundStart', 'LONG_PTR', 'SVSFDefault', 'DISPID_SDKDeleteKey',
    'DISPID_SRCERequestUI', 'SAFTCCITT_uLaw_44kHzStereo',
    'SP_VISEME_9', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPWF_SRENGINE', 'DISPID_SRCPause', 'SP_VISEME_1',
    'DISPID_SRRSpeakAudio', 'SP_VISEME_20', 'DISPID_SPIProperties',
    'SpeechCategoryAppLexicons', 'SPAS_RUN', 'SAFT32kHz8BitStereo',
    'ISpeechGrammarRuleStateTransitions', 'ISpPhraseAlt',
    'SPSHORTCUTTYPE', 'SVF_None', 'DISPID_SLWs_NewEnum',
    'ISpeechPhraseInfo', 'DISPID_SOTCGetDataKey',
    'DISPID_SpeechCustomStream', 'SAFTCCITT_ALaw_8kHzStereo',
    'SREInterference', 'SAFT24kHz8BitStereo',
    'DISPID_SRSCurrentStreamPosition', 'SVP_3',
    'SpeechDisplayAttributes', 'DISPID_SVSpeak',
    'ISpeechWaveFormatEx', 'DISPID_SRRPhraseInfo',
    'DISPID_SVDisplayUI', 'SpeechEmulationCompareFlags',
    'SWPUnknownWordUnpronounceable', 'SPLO_STATIC',
    'DISPID_SWFEExtraData', 'Speech_Default_Weight',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPAs_NewEnum',
    'ISpeechLexiconPronunciation', 'SP_VISEME_17', 'DISPID_SOTId',
    'DISPID_SASNonBlockingIO', 'eLEXTYPE_PRIVATE4',
    'SAFTADPCM_11kHzMono', 'DISPID_SGRsDynamic',
    'DISPID_SRSClsidEngine', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SWFEChannels', 'SPWF_INPUT', 'SECHighConfidence',
    'SPFM_NUM_MODES', 'SGDSInactive', 'SRAExport',
    'DISPID_SABufferInfo', 'eLEXTYPE_VENDORLEXICON',
    'SVEStartInputStream', 'eLEXTYPE_RESERVED9', 'ISpeechLexicon',
    'SpeechUserTraining', 'SpeechRetainedAudioOptions',
    'SECLowConfidence', 'SDKLLocalMachine', 'SPPS_Noncontent',
    'SAFTDefault', 'SpCompressedLexicon', 'SpeechAudioProperties',
    'SRTStandard', 'DISPID_SRAudioInputStream', 'SVP_8',
    'DISPID_SRCEEndStream', 'SAFTCCITT_ALaw_8kHzMono',
    'SpeechPropertyResourceUsage', 'DISPID_SGRSTType',
    'SPEI_SOUND_END', 'ISpeechGrammarRuleState', 'ISpRecoGrammar2',
    'DISPID_SDKSetStringValue', 'eLEXTYPE_PRIVATE1',
    'DISPID_SpeechPhraseRule', 'SpMemoryStream', 'DISPID_SPRulesItem',
    'SREAudioLevel', 'DISPID_SADefaultFormat',
    'DISPID_SOTCEnumerateTokens', 'SPSEMANTICFORMAT', 'SGRSTTEpsilon',
    'SLTApp', 'tagSPTEXTSELECTIONINFO', 'SREPropertyStringChange',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRRecognizer',
    'DISPID_SRGDictationSetState', '_SPAUDIOSTATE',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SOTDataKey',
    'DISPID_SRGCmdLoadFromFile', 'eLEXTYPE_USER', 'SPEI_ADAPTATION',
    'SPCT_SLEEP', 'SPSVerb', 'SAFT24kHz16BitStereo',
    'SpTextSelectionInformation', 'ISpLexicon', 'eLEXTYPE_RESERVED4',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SOTCDefault', 'SGSDisabled',
    'SVP_17', 'ISpeechLexiconPronunciations', 'SPGS_DISABLED',
    'ISpMMSysAudio', 'DISPID_SPEAudioSizeBytes',
    'SSSPTRelativeToCurrentPosition', 'SREPrivate',
    'SPSMF_SAPI_PROPERTIES', 'DISPIDSPTSI_SelectionOffset',
    'SpeechWordPronounceable', 'SVP_2', 'DISPID_SLPs_NewEnum',
    'SREPhraseStart', 'ISpeechObjectTokenCategory',
    'DISPID_SpeechObjectTokens', 'DISPID_SLWType', 'SPSSuppressWord',
    'DISPID_SpeechRecoContext', 'SVSFPersistXML', 'SRSEIsSpeaking',
    'SpPhraseInfoBuilder', 'DISPID_SPEEngineConfidence',
    'DISPID_SASState', 'SAFT22kHz16BitStereo',
    'DISPID_SRRRecoContext', 'DISPID_SLRemovePronunciation',
    'SRADefaultToActive', 'SpeechTokenContext',
    'SpStreamFormatConverter', 'DISPID_SpeechPhoneConverter',
    'DISPID_SAFType', 'DISPID_SFSOpen', 'DISPID_SRState',
    'SPPS_Interjection', 'SPEI_VISEME', 'DISPID_SPEsItem',
    ...
    'DISPID_SOTCreateInstance', 'SDA_One_Trailing_Space',
    'SPBINARYGRAMMAR', 'SpeechRuleAttributes', 'ISpVoice',
    'DISPID_SRCResume', 'DISPID_SRRSaveToMemory',
    'DISPID_SRRGetXMLResult', 'ISpeechRecognizerStatus',
    'SPEI_SOUND_START', 'SpVoice', 'DISPID_SVWaitUntilDone',
    'SPBO_AHEAD', 'SpeechAudioVolume', 'SAFT32kHz16BitMono',
    'SpeechRecognitionType', 'SPGRAMMARWORDTYPE',
    'DISPID_SPIGetDisplayAttributes', 'SPCT_COMMAND',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPRs_NewEnum',
    'SpInprocRecognizer', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SOTGetDescription', 'SAFT22kHz16BitMono',
    'SPBOOKMARKOPTIONS', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SWFEBlockAlign', 'ISpeechRecoGrammar',
    'SpeechAudioFormatGUIDText', 'SPVISEMES', 'WAVEFORMATEX',
    'SPSERIALIZEDPHRASE', 'IStream', 'ISpStream', 'DISPID_SAStatus',
    'DISPID_SRCSetAdaptationData', 'DISPID_SOTRemove',
    'SPRST_INACTIVE_WITH_PURGE', 'SVP_6', 'SPPS_NotOverriden',
    'SPPHRASEELEMENT', 'SPINTERFERENCE_LATENCY_WARNING',
    'SAFT24kHz16BitMono', 'SGDSActiveUserDelimited', 'SSFMCreate',
    'SpeechLoadOption', 'SPWORDTYPE', 'SpFileStream',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SpeechVoiceStatus', 'SPAUDIOSTATE',
    'SpeechRecoEvents', 'SpMMAudioIn', 'SpeechInterference',
    'SVSFIsNotXML', 'SPPROPERTYINFO', 'SPSInterjection',
    'SAFTADPCM_8kHzMono', 'DISPID_SPCPhoneToId',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPPId', 'DISPID_SPPChildren',
    'SPDKL_CurrentConfig', 'SAFT44kHz8BitMono', 'DISPID_SGRSTsCount',
    'SVP_4', 'DISPID_SOTSetId', 'DISPID_SRRSetTextFeedback',
    'ISpeechPhraseRules', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SRCAudioInInterferenceStatus', 'SVP_16',
    'DISPID_SpeechPhraseBuilder', 'SPEI_START_SR_STREAM',
    'ISpObjectToken', 'SSTTWildcard', 'eLEXTYPE_PRIVATE8',
    'DISPID_SVSpeakStream', 'DISPID_SPRText', 'SP_VISEME_8', 'SVP_10',
    'ISpNotifySource', 'SPCT_DICTATION', 'SPEI_MAX_TTS',
    'DISPID_SRGetRecognizers', 'DISPID_SGRAddResource',
    'SpeechVisemeFeature', 'DISPID_SVSLastBookmarkId',
    'SVSFVoiceMask', 'SFTInput', 'DISPID_SPEPronunciation',
    'SREBookmark', 'SAFTCCITT_uLaw_8kHzMono', 'SPRST_ACTIVE_ALWAYS',
    'STCAll', 'ISpeechTextSelectionInformation',
    'DISPID_SVEventInterests', 'ISpeechResourceLoader',
    'DISPID_SOTCSetId', 'eLEXTYPE_PRIVATE9', 'DISPID_SVSkip',
    'ISpeechPhraseAlternates', 'DISPID_SGRId',
    'SpeechCategoryRecognizers', 'DISPID_SVIsUISupported',
    'SPEI_PHONEME', 'DISPID_SOTs_NewEnum', 'SPEI_SR_BOOKMARK',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SVESentenceBoundary',
    'STCInprocServer', 'SLODynamic', 'DISPID_SRGReset',
    'SPAO_RETAIN_AUDIO', 'SPBO_NONE',
    ...
    'DISPID_SpeechFileStream', 'SPSHORTCUTPAIRLIST', 'SpWaveFormatEx',
    ...
    'DISPID_SPRDisplayAttributes', 'SVP_20', 'SDTPronunciation',
    'DISPID_SpeechGrammarRule', 'ISpeechFileStream',
    'eLEXTYPE_PRIVATE15', 'SPXRO_SML', 'ISpRecoGrammar',
    ...
    'DISPID_SRCESoundEnd', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRCRetainedAudio', 'SRERecoOtherContext', 'SGDSActive',
    'SpeechMicTraining', 'SpPhoneticAlphabetConverter',
    'DISPID_SASetState', 'SAFT32kHz16BitStereo', 'DISPID_SRCBookmark',
    'SINoSignal', 'ISpRecoCategory', 'SGPronounciation',
    ...
    'SAFTADPCM_44kHzMono', 'DISPID_SPANumberOfElementsInResult',
    'SPPS_LMA', 'DISPID_SpeechObjectToken', 'SPSFunction', 'SPEVENT',
    'DISPID_SPIStartTime', 'SPFILEMODE', 'IEnumString',
    'DISPID_SpeechObjectTokenCategory', 'SVPNormal', 'SPPHRASE',
    'SAFT12kHz8BitMono', 'IInternetSecurityManager',
    'SAFTADPCM_8kHzStereo', 'eLEXTYPE_RESERVED6', 'SVP_1',
    'DISPID_SPRNumberOfElements', 'SRAImport',
    'SpeechStreamSeekPositionType', 'SAFT22kHz8BitMono',
    'SP_VISEME_14', 'SDTAudio', 'DISPID_SpeechRecognizerStatus',
    ...
    'DISPID_SRRTimes', 'SECFNoSpecialChars', 'SP_VISEME_11',
    'SP_VISEME_15', 'SSFMCreateForWrite', 'DISPID_SLPSymbolic',
    'eLEXTYPE_PRIVATE13', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SVAudioOutput', 'DISPID_SOTRemoveStorageFileName',
    'SPPS_Modifier', 'STSF_LocalAppData',
    'DISPID_SRGSetWordSequenceData', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SLPLangId', 'SVSFlagsAsync', 'ISpStreamFormatConverter',
    ...
    'DISPID_SPPEngineConfidence', 'SREStreamStart', 'SAFTText',
    'SAFT16kHz16BitStereo', 'SpMMAudioOut', 'SPDKL_LocalMachine',
    'DISPID_SDKCreateKey', 'DISPID_SVEWord', 'SVEAudioLevel',
    'SpeechPropertyNormalConfidenceThreshold', 'SVSFIsFilename',
    'SPCONTEXTSTATE', 'SpeechCategoryRecoProfiles',
    'DISPID_SRCEventInterests', 'SPWAVEFORMATTYPE', 'SPPHRASERULE',
    'DISPID_SPIAudioSizeTime', 'DISPID_SBSRead',
    'SSSPTRelativeToStart', 'SP_VISEME_12', 'SPRECORESULTTIMES',
    'DISPID_SGRsItem', 'DISPID_SpeechPhraseProperties',
    'SPPS_RESERVED2', 'SVP_18', 'DISPID_SPARecoResult', 'SRAONone',
    'DISPID_SVPause', 'STCInprocHandler', 'SpeechBookmarkOptions',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPWORDPRONUNCIATIONLIST',
    'SPPARTOFSPEECH', 'SAFTTrueSpeech_8kHz1BitMono',
    'eLEXTYPE_RESERVED7', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SGRsAdd', 'DISPIDSPRG', 'ISpRecoResult',
    'ISpObjectWithToken', 'ISequentialStream', 'DISPID_SPCLangId',
    'SWTAdded', 'DISPID_SRGDictationLoad', 'SPGS_EXCLUSIVE',
    'DISPID_SGRSTNextState', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SPPValue', 'SPEI_MIN_SR', 'SAFT12kHz16BitStereo',
    'SPEI_INTERFERENCE', 'DISPID_SOTsItem', 'DISPID_SLPPhoneIds',
    'SECFDefault', 'ISpeechGrammarRule',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SpeechGrammarTagDictation', 'SpInProcRecoContext',
    'DISPID_SAFSetWaveFormatEx', 'SpeechAddRemoveWord',
    'SAFT22kHz8BitStereo', 'SpMMAudioEnum', 'SPINTERFERENCE_NONE',
    '_ISpeechVoiceEvents', 'DISPID_SRIsShared', 'SVSFParseSsml',
    'SpeechDictationTopicSpelling', 'DISPID_SRGCmdSetRuleState',
    'SPSHT_EMAIL', 'DISPID_SPIEnginePrivateData',
    'DISPID_SVEStreamEnd', 'SVEEndInputStream', 'SRTSMLTimeout',
    'DISPID_SRStatus', 'ISpRecoContext', 'SpeechAllElements',
    'DISPID_SVSRunningState', 'DISPID_SpeechPhraseAlternate',
    'SGDisplay', 'SpeechGrammarTagWildcard', 'SPSHORTCUTPAIR',
    'DISPID_SRRAudio', 'SITooLoud', 'eLEXTYPE_PRIVATE17',
    'ISpeechPhraseRule', 'SPEI_RESERVED1',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SPAsItem', 'SPAS_PAUSE',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SABIMinNotification',
    'DISPID_SPELexicalForm', 'DISPID_SGRsCount',
    'ISpPhoneticAlphabetSelection', 'SPEI_UNDEFINED',
    'SpeechPropertyLowConfidenceThreshold', 'SpeechTokenShellFolder',
    'DISPID_SRRTStreamTime', 'DISPID_SVSInputWordLength',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SVSLastStreamNumberQueued',
    'SPEVENTENUM', 'SDKLCurrentUser', 'DISPID_SPISaveToMemory',
    'SpSharedRecoContext', 'SRERecognition', 'DISPID_SRCEPhraseStart',
    'SPBO_TIME_UNITS', 'DISPID_SVSLastResult',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFTCCITT_ALaw_22kHzStereo',
    'ISpeechGrammarRuleStateTransition', 'SPEI_RESERVED5',
    'DISPID_SPEActualConfidence', 'DISPID_SpeechAudioBufferInfo',
    'SVEWordBoundary', 'DISPID_SpeechAudioStatus',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRGRules', 'DISPID_SGRInitialState', 'DISPID_SGRName',
    'SPWORDLIST', 'DISPID_SPRuleId', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SLWPronunciations', 'SGRSTTDictation',
    'SPAUDIOBUFFERINFO', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SOTGetStorageFileName',
    'SAFTGSM610_44kHzMono', 'SPCS_ENABLED', 'SVP_11',
    'SVESentenceBoundary', 'DISPID_SVSyncronousSpeakTimeout',
    'ISpeechCustomStream', 'SAFTADPCM_11kHzStereo',
    'SAFT24kHz8BitMono', 'SAFT44kHz16BitStereo', 'SPEI_PHRASE_START',
    'SRSEDone', 'DISPID_SRRTLength', 'DISPID_SpeechLexicon',
    'DISPID_SpeechPhraseElement', 'DISPID_SPEs_NewEnum',
    'SpeechFormatType', 'SVP_13', 'DISPID_SpeechMMSysAudio',
    'SP_VISEME_16', 'eLEXTYPE_RESERVED10', 'SpNotifyTranslator',
    'SVP_0', 'Speech_Max_Pron_Length', 'DISPID_SVEEnginePrivate',
    'ISpeechAudio', 'SPCS_DISABLED', 'SREAllEvents', 'SPLOADOPTIONS',
    'ISpeechBaseStream', 'ISpeechRecognizer', 'SpShortcut',
    'SPVOICESTATUS', 'SPWT_PRONUNCIATION', 'ISpeechAudioStatus',
    'eLEXTYPE_PRIVATE19', 'SpeechLexiconType',
